...
public class DomainModel extends ModelObject {

	private final List<ModelClass> masterDataClasses = new ArrayList<>();
	private final List<ModelClass> businessObjectClasses = new ArrayList<>();
